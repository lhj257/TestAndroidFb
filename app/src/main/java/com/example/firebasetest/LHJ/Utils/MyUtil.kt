package com.example.firebasetest.LHJ.Utils
    ...
    companion object{
        ...
        fun checkPermission(activity:AppCompatActivity){
            ...
            val requestPermissionLauncher =activity.registerForActivityResult(
                ...
                if(it){
                    Toast.makeText(activity,"권한 승인 됨",Toast.LENGTH_SHORT).show()
                }else{
            ...
            //33 버전 미만 :READ_EXTERNAL_STORAGE
